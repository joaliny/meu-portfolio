...
function Projects() {
    ...
    // ✅ BASE_URL para imagens na pasta public
...
A aplicação conta com seções estratégicas como carrossel interativo, apresentação dos tipos de grama, portfólio de trabalhos realizados, diferenciais da empresa e informações institucionais. O sistema foi construído utilizando Python com Django no back-end e HTML, CSS e JavaScript no front-end, garantindo uma navegação fluida, responsiva e uma experiência agradável ao usuário.`,
                        ...
                        >
                            ...
                            <div className="card-expandable-content">
                                <button
                                    ...
                                    onClick={(e) => handleVerMaisClick(project, e)}
                                >
                                    Ver mais
